var monopgui = {
	...
	updategame: function (id){
		...
		this.gamelistlines[id].innerHTML = monopc.games[id].name + " (" + monopc.gametypes[monopc.games[id].gametype].name + " " + monopc.games[id].player + " Players) - " + monopc.games[id].description;
	}
};